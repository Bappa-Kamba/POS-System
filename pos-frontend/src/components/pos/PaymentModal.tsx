            ...
            <div className="flex flex-wrap gap-2">
              {quickAmounts.map((amt) => (
                <button
                  ...
                  className="px-3 py-1 text-sm bg-neutral-100 dark:bg-neutral-700 hover:bg-neutral-200 dark:hover:bg-neutral-600 rounded border border-neutral-300 dark:border-neutral-600 transition-colors"
                >
                  {formatCurrency(amt)}
                </button>
              ))}
