...
INSERT INTO "new_sales" ("amountDue", "amountPaid", "branchId", "cashierId", "changeGiven", "createdAt", "customerName", "customerPhone", "discountAmount", "id", "notes", "paymentStatus", "receiptNumber", "subtotal", "taxAmount", "totalAmount", "updatedAt") SELECT "amountDue", "amountPaid", "branchId", "cashierId", "changeGiven", "createdAt", "customerName", "customerPhone", "discountAmount", "id", "notes", "paymentStatus", "receiptNumber", "subtotal", "taxAmount", "totalAmount", "updatedAt" FROM "sales";
DROP TABLE "sales";
