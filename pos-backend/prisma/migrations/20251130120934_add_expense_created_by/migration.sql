...
INSERT INTO "new_expenses" ("amount", "branchId", "category", "createdAt", "createdById", "date", "description", "id", "sessionId", "title", "updatedAt") SELECT "amount", "branchId", "category", "createdAt", "createdById", "date", "description", "id", "sessionId", "title", "updatedAt" FROM "expenses";
DROP TABLE "expenses";
